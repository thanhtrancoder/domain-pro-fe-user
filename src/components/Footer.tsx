...
const certificateList: menuType[] = [
  {
    label: "SSL Secured",
    href: "",
    icon: (
      <svg
        className="text-fourth-hover h-6 w-6"
        aria-hidden="true"
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
        ...
        <div className="flex flex-col space-y-8">
          ...
          <div className="flex flex-col space-y-3">
            ...
            <div className="relative">
              <input
                className="w-full rounded-lg border border-gray-500 bg-gray-700 px-4 py-2"
              ...
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="absolute top-2 right-0 mr-3 size-6 text-gray-500"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <button className="bg-primary-hover hover:bg-primary cursor-pointer rounded-lg px-4 py-2 font-medium text-white transition-colors duration-300">
              Đăng ký
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex space-x-4">
            {socialList.map((socialItem: menuType, index: number) => (
              <a
                key={index}
                className="hover:bg-primary rounded-lg bg-gray-600 p-2 transition-colors duration-300"
