      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-3xl text-xl text-gray-600">
            Đội ngũ hỗ trợ của chúng tôi luôn sẵn sàng giúp đỡ bạn với mọi câu
            hỏi về đăng ký tên miền, quản lý và các dịch vụ khác.
          </p>
        </div>
        ...
        <div className="mb-12 grid gap-8 lg:grid-cols-3">
          ...
          <div className="rounded-xl bg-white p-6 shadow-md transition-shadow duration-300 hover:shadow-lg">
            ...
            <p className="mb-1 text-gray-600">720A Điện Biên Phủ, Phường 22</p>
            <p className="text-sm text-gray-500">
